 ...
 *
 * @Author: gjh
 * @Date: 2025/12/17 13:40
 **/
@Environment(EnvType.CLIENT)
public class HalfBedItemRenderer implements BuiltinItemRendererRegistry.DynamicItemRenderer {
    private ModelPart bedHead;
    private ModelPart bedFoot;
    private boolean initialized = false;
    private String name;
    public HalfBedItemRenderer(String name) {
        this.name = name;
