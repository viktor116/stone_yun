 ...
 * @description
 */
public class DirtBucketItem extends Item implements FluidModificationItem {
    private final Fluid fluid;

    public DirtBucketItem(Fluid fluid, Settings settings) {
        super(settings);
        this.fluid = fluid;
    }
                    ...
                    if (var14 instanceof FluidDrainable) {
                        ...
                        if (!itemStack2.isEmpty()) {
                            ...
                            if(itemStack2.isOf(Items.LAVA_BUCKET)){
                                itemStack2 = ItemsRegister.DIRT_LAVA_BUCKET.getDefaultStack();
                            }else if(itemStack2.isOf(Items.WATER_BUCKET)){
                                itemStack2 = ItemsRegister.DIRT_WATER_BUCKET.getDefaultStack();
                            }
    ...
    public static ItemStack getEmptiedStack(ItemStack stack, PlayerEntity player) {
        return !player.isInCreativeMode() ? new ItemStack(ItemsRegister.DIRT_BUCKET) : stack;
    }
