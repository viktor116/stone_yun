 ...
 * @description
 */
public class MinecartHatItem extends ArmorItem implements GeoItem {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public MinecartHatItem() {
        super(ArmorMaterials.IRON, ArmorItem.Type.HELMET,
        ...
        consumer.accept(new GeoRenderProvider() {
            ...
            public <T extends LivingEntity> BipedEntityModel<?> getGeoArmorRenderer(
                ...
                if (this.renderer == null) {
                    this.renderer = new MinecartHatRenderer();
                }
