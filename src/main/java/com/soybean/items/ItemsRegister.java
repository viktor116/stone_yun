...
import com.soybean.items.material.*;
...
public class ItemsRegister {
    ...
    public static final Item MACE_FISHING_ROD = register(new MaceFishingRodItem(new Item.Settings().maxCount(1).maxDamage(128)),"mace_fishing_rod");
    ...
    public static final Item COPPER_HELMET = register(new ArmorItem(ModArmorMaterials.COPPER_ARMOR_MATERIAL, ArmorItem.Type.HELMET, new Item.Settings().maxDamage(ArmorItem.Type.HELMET.getMaxDamage(15))), "copper_helmet");
    public static final Item COPPER_CHESTPLATE = register(new ArmorItem(ModArmorMaterials.COPPER_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE, new Item.Settings().maxDamage(ArmorItem.Type.CHESTPLATE.getMaxDamage(15))), "copper_chestplate");
    public static final Item COPPER_LEGGINGS = register(new ArmorItem(ModArmorMaterials.COPPER_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS, new Item.Settings().maxDamage(ArmorItem.Type.LEGGINGS.getMaxDamage(15))), "copper_leggings");
    public static final Item COPPER_BOOTS = register(new ArmorItem(ModArmorMaterials.COPPER_ARMOR_MATERIAL, ArmorItem.Type.BOOTS, new Item.Settings().maxDamage(ArmorItem.Type.BOOTS.getMaxDamage(15))), "copper_boots");
    public static final Item EXPOSED_COPPER_HELMET = register(new ArmorItem(ModArmorMaterials.EXPOSED_COPPER_ARMOR_MATERIAL, ArmorItem.Type.HELMET, new Item.Settings().maxDamage(ArmorItem.Type.HELMET.getMaxDamage(15))), "exposed_copper_helmet");
    public static final Item EXPOSED_COPPER_CHESTPLATE = register(new ArmorItem(ModArmorMaterials.EXPOSED_COPPER_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE, new Item.Settings().maxDamage(ArmorItem.Type.CHESTPLATE.getMaxDamage(15))), "exposed_copper_chestplate");
    public static final Item EXPOSED_COPPER_LEGGINGS = register(new ArmorItem(ModArmorMaterials.EXPOSED_COPPER_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS, new Item.Settings().maxDamage(ArmorItem.Type.LEGGINGS.getMaxDamage(15))), "exposed_copper_leggings");
    public static final Item EXPOSED_COPPER_BOOTS = register(new ArmorItem(ModArmorMaterials.EXPOSED_COPPER_ARMOR_MATERIAL, ArmorItem.Type.BOOTS, new Item.Settings().maxDamage(ArmorItem.Type.BOOTS.getMaxDamage(15))), "exposed_copper_boots");
    public static final Item WEATHERED_COPPER_HELMET = register(new ArmorItem(ModArmorMaterials.WEATHERED_COPPER_ARMOR_MATERIAL, ArmorItem.Type.HELMET, new Item.Settings().maxDamage(ArmorItem.Type.HELMET.getMaxDamage(15))), "weathered_copper_helmet");
    public static final Item WEATHERED_COPPER_CHESTPLATE = register(new ArmorItem(ModArmorMaterials.WEATHERED_COPPER_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE, new Item.Settings().maxDamage(ArmorItem.Type.CHESTPLATE.getMaxDamage(15))), "weathered_copper_chestplate");
    public static final Item WEATHERED_COPPER_LEGGINGS = register(new ArmorItem(ModArmorMaterials.WEATHERED_COPPER_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS, new Item.Settings().maxDamage(ArmorItem.Type.LEGGINGS.getMaxDamage(15))), "weathered_copper_leggings");
    public static final Item WEATHERED_COPPER_BOOTS = register(new ArmorItem(ModArmorMaterials.WEATHERED_COPPER_ARMOR_MATERIAL, ArmorItem.Type.BOOTS, new Item.Settings().maxDamage(ArmorItem.Type.BOOTS.getMaxDamage(15))), "weathered_copper_boots");
    public static final Item OXIDIZED_COPPER_HELMET = register(new ArmorItem(ModArmorMaterials.OXIDIZED_COPPER_ARMOR_MATERIAL, ArmorItem.Type.HELMET, new Item.Settings().maxDamage(ArmorItem.Type.HELMET.getMaxDamage(15))), "oxidized_copper_helmet");
    public static final Item OXIDIZED_COPPER_CHESTPLATE = register(new ArmorItem(ModArmorMaterials.OXIDIZED_COPPER_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE, new Item.Settings().maxDamage(ArmorItem.Type.CHESTPLATE.getMaxDamage(15))), "oxidized_copper_chestplate");
    public static final Item OXIDIZED_COPPER_LEGGINGS = register(new ArmorItem(ModArmorMaterials.OXIDIZED_COPPER_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS, new Item.Settings().maxDamage(ArmorItem.Type.LEGGINGS.getMaxDamage(15))), "oxidized_copper_leggings");
    public static final Item OXIDIZED_COPPER_BOOTS = register(new ArmorItem(ModArmorMaterials.OXIDIZED_COPPER_ARMOR_MATERIAL, ArmorItem.Type.BOOTS, new Item.Settings().maxDamage(ArmorItem.Type.BOOTS.getMaxDamage(15))), "oxidized_copper_boots");
    public static final Item WAXED_COPPER_HELMET = register(new ArmorItem(ModArmorMaterials.WAXED_COPPER_ARMOR_MATERIAL, ArmorItem.Type.HELMET, new Item.Settings().maxDamage(ArmorItem.Type.HELMET.getMaxDamage(15))), "waxed_copper_helmet");
    public static final Item WAXED_COPPER_CHESTPLATE = register(new ArmorItem(ModArmorMaterials.WAXED_COPPER_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE, new Item.Settings().maxDamage(ArmorItem.Type.CHESTPLATE.getMaxDamage(15))), "waxed_copper_chestplate");
    public static final Item WAXED_COPPER_LEGGINGS = register(new ArmorItem(ModArmorMaterials.WAXED_COPPER_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS, new Item.Settings().maxDamage(ArmorItem.Type.LEGGINGS.getMaxDamage(15))), "waxed_copper_leggings");
    public static final Item WAXED_COPPER_BOOTS = register(new ArmorItem(ModArmorMaterials.WAXED_COPPER_ARMOR_MATERIAL, ArmorItem.Type.BOOTS, new Item.Settings().maxDamage(ArmorItem.Type.BOOTS.getMaxDamage(15))), "waxed_copper_boots");
    public static final Item LICHEN_DIAMOND_HELMET = register(new ArmorItem(ModArmorMaterials.LICHEN_DIAMOND_ARMOR_MATERIAL, ArmorItem.Type.HELMET, new Item.Settings().maxDamage(ArmorItem.Type.HELMET.getMaxDamage(15))), "lichen_diamond_helmet");
    public static final Item LICHEN_DIAMOND_CHESTPLATE = register(new ArmorItem(ModArmorMaterials.LICHEN_DIAMOND_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE, new Item.Settings().maxDamage(ArmorItem.Type.CHESTPLATE.getMaxDamage(15))), "lichen_diamond_chestplate");
    public static final Item LICHEN_DIAMOND_LEGGINGS = register(new ArmorItem(ModArmorMaterials.LICHEN_DIAMOND_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS, new Item.Settings().maxDamage(ArmorItem.Type.LEGGINGS.getMaxDamage(15))), "lichen_diamond_leggings");
    public static final Item LICHEN_DIAMOND_BOOTS = register(new ArmorItem(ModArmorMaterials.LICHEN_DIAMOND_ARMOR_MATERIAL, ArmorItem.Type.BOOTS, new Item.Settings().maxDamage(ArmorItem.Type.BOOTS.getMaxDamage(15))), "lichen_diamond_boots");
    public static final Item COPPER_SWORD = register(new SwordItem(CopperToolMaterial.INSTANCE, new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(CopperToolMaterial.INSTANCE, 3, -2.4F)).maxCount(1).maxDamage(250)), "copper_sword");
    public static final Item COPPER_AXE = register(new AxeItem(CopperToolMaterial.INSTANCE, new Item.Settings().attributeModifiers(AxeItem.createAttributeModifiers(CopperToolMaterial.INSTANCE, 6.0F, -3.2F)).maxCount(1).maxDamage(250)), "copper_axe");
    public static final Item COPPER_PICKAXE_TOOL = register(new PickaxeItem(CopperToolMaterial.INSTANCE, (new Item.Settings()).attributeModifiers(PickaxeItem.createAttributeModifiers(CopperToolMaterial.INSTANCE, 1.0F, -2.8F)).maxCount(1).maxDamage(250)), "copper_tool_pickaxe");
    public static final Item EXPOSED_COPPER_SWORD = register(new SwordItem(ExposedCopperToolMaterial.INSTANCE, new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(ExposedCopperToolMaterial.INSTANCE, 3, -2.4F)).maxCount(1).maxDamage(200)), "exposed_copper_sword");
    public static final Item EXPOSED_COPPER_AXE = register(new AxeItem(ExposedCopperToolMaterial.INSTANCE, new Item.Settings().attributeModifiers(AxeItem.createAttributeModifiers(ExposedCopperToolMaterial.INSTANCE, 6.0F, -3.2F)).maxCount(1).maxDamage(200)), "exposed_copper_axe");
    public static final Item EXPOSED_COPPER_PICKAXE = register(new PickaxeItem(ExposedCopperToolMaterial.INSTANCE, (new Item.Settings()).attributeModifiers(PickaxeItem.createAttributeModifiers(ExposedCopperToolMaterial.INSTANCE, 1.0F, -2.8F)).maxCount(1).maxDamage(200)), "exposed_copper_pickaxe");
    public static final Item WEATHERED_COPPER_SWORD = register(new SwordItem(WeatheredCopperToolMaterial.INSTANCE, new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(WeatheredCopperToolMaterial.INSTANCE, 3, -2.4F)).maxCount(1).maxDamage(150)), "weathered_copper_sword");
    public static final Item WEATHERED_COPPER_AXE = register(new AxeItem(WeatheredCopperToolMaterial.INSTANCE, new Item.Settings().attributeModifiers(AxeItem.createAttributeModifiers(WeatheredCopperToolMaterial.INSTANCE, 6.0F, -3.2F)).maxCount(1).maxDamage(150)), "weathered_copper_axe");
    public static final Item WEATHERED_COPPER_PICKAXE = register(new PickaxeItem(WeatheredCopperToolMaterial.INSTANCE, (new Item.Settings()).attributeModifiers(PickaxeItem.createAttributeModifiers(WeatheredCopperToolMaterial.INSTANCE, 1.0F, -2.8F)).maxCount(1).maxDamage(150)), "weathered_copper_pickaxe");
    public static final Item OXIDIZED_COPPER_SWORD = register(new SwordItem(OxidizedCopperToolMaterial.INSTANCE, new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(OxidizedCopperToolMaterial.INSTANCE, 3, -2.4F)).maxCount(1).maxDamage(100)), "oxidized_copper_sword");
    public static final Item OXIDIZED_COPPER_AXE = register(new AxeItem(OxidizedCopperToolMaterial.INSTANCE, new Item.Settings().attributeModifiers(AxeItem.createAttributeModifiers(OxidizedCopperToolMaterial.INSTANCE, 6.0F, -3.2F)).maxCount(1).maxDamage(100)), "oxidized_copper_axe");
    public static final Item OXIDIZED_COPPER_PICKAXE = register(new PickaxeItem(OxidizedCopperToolMaterial.INSTANCE, (new Item.Settings()).attributeModifiers(PickaxeItem.createAttributeModifiers(OxidizedCopperToolMaterial.INSTANCE, 1.0F, -2.8F)).maxCount(1).maxDamage(100)), "oxidized_copper_pickaxe");
    public static final Item WAXED_COPPER_SWORD = register(new SwordItem(WaxedCopperToolMaterial.INSTANCE, new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(WaxedCopperToolMaterial.INSTANCE, 3, -2.4F)).maxCount(1).maxDamage(250)), "waxed_copper_sword");
    public static final Item WAXED_COPPER_AXE = register(new AxeItem(WaxedCopperToolMaterial.INSTANCE, new Item.Settings().attributeModifiers(AxeItem.createAttributeModifiers(WaxedCopperToolMaterial.INSTANCE, 6.0F, -3.2F)).maxCount(1).maxDamage(250)), "waxed_copper_axe");
    public static final Item WAXED_COPPER_PICKAXE = register(new PickaxeItem(WaxedCopperToolMaterial.INSTANCE, (new Item.Settings()).attributeModifiers(PickaxeItem.createAttributeModifiers(WaxedCopperToolMaterial.INSTANCE, 1.0F, -2.8F)).maxCount(1).maxDamage(250)), "waxed_copper_pickaxe");
    ...
    public static final Item MACE_BOW = register(new MaceBowItem(new Item.Settings().maxCount(1).maxDamage(384)), "mace_bow");
    ...
    public static final Item MACE_CROSSBOW = register(new MaceCrossbowItem(new Item.Settings().maxCount(1).maxDamage(326)), "mace_crossbow");
    public static final Item FALL_SPYGLASS = register(new FallSpyglassItem(new Item.Settings().maxCount(1)), "fall_spyglass");
    public static final Item ARROW_BOW = register(new com.soybean.items.item.ArrowBowItem(new Item.Settings().maxCount(1).maxDamage(384)), "arrow_bow");
...
//        ModRecipes.registerRecipes();
        ...
        ItemGroupEvents.modifyEntriesEvent(FUN_ITEM_GROUP_KEY).register(itemGroup->{
            ...
            itemGroup.add(EXPOSED_COPPER_HELMET);
            itemGroup.add(EXPOSED_COPPER_CHESTPLATE);
            itemGroup.add(EXPOSED_COPPER_LEGGINGS);
            itemGroup.add(EXPOSED_COPPER_BOOTS);
            itemGroup.add(WEATHERED_COPPER_HELMET);
            itemGroup.add(WEATHERED_COPPER_CHESTPLATE);
            itemGroup.add(WEATHERED_COPPER_LEGGINGS);
            itemGroup.add(WEATHERED_COPPER_BOOTS);
            itemGroup.add(OXIDIZED_COPPER_HELMET);
            itemGroup.add(OXIDIZED_COPPER_CHESTPLATE);
            itemGroup.add(OXIDIZED_COPPER_LEGGINGS);
            itemGroup.add(OXIDIZED_COPPER_BOOTS);
            itemGroup.add(WAXED_COPPER_HELMET);
            itemGroup.add(WAXED_COPPER_CHESTPLATE);
            itemGroup.add(WAXED_COPPER_LEGGINGS);
            itemGroup.add(WAXED_COPPER_BOOTS);
            itemGroup.add(LICHEN_DIAMOND_HELMET);
            itemGroup.add(LICHEN_DIAMOND_CHESTPLATE);
            itemGroup.add(LICHEN_DIAMOND_LEGGINGS);
            itemGroup.add(LICHEN_DIAMOND_BOOTS);
            itemGroup.add(COPPER_SWORD);
            itemGroup.add(COPPER_AXE);
            itemGroup.add(COPPER_PICKAXE);
            itemGroup.add(EXPOSED_COPPER_SWORD);
            itemGroup.add(EXPOSED_COPPER_AXE);
            itemGroup.add(EXPOSED_COPPER_PICKAXE);
            itemGroup.add(WEATHERED_COPPER_SWORD);
            itemGroup.add(WEATHERED_COPPER_AXE);
            itemGroup.add(WEATHERED_COPPER_PICKAXE);
            itemGroup.add(OXIDIZED_COPPER_SWORD);
            itemGroup.add(OXIDIZED_COPPER_AXE);
            itemGroup.add(OXIDIZED_COPPER_PICKAXE);
            itemGroup.add(WAXED_COPPER_SWORD);
            itemGroup.add(WAXED_COPPER_AXE);
            itemGroup.add(WAXED_COPPER_PICKAXE);
            itemGroup.add(LICHEN_DIAMOND);
            itemGroup.add(ModBlock.LICHEN_DIAMOND_ORE);
            itemGroup.add(ModBlock.DEEPSLATE_DIAMOND_ORE);
            itemGroup.add(ModBlock.FALL_OAK_LOG);
            itemGroup.add(ModBlock.FALL_OAK_PLANKS);
            itemGroup.add(ModBlock.FALL_CRAFTING_TABLE);
            itemGroup.add(ModBlock.FALL_FURNACE);
            itemGroup.add(ModBlock.EXTINGUISH_TORCH);
            itemGroup.add(ModBlock.MAIN_RESPAWN_ANCHOR);
            itemGroup.add(MACE_BOW);
            itemGroup.add(MACE_CROSSBOW);
            itemGroup.add(FALL_SPYGLASS);
