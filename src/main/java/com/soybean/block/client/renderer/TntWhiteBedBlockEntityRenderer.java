...
public class TntWhiteBedBlockEntityRenderer implements BlockEntityRenderer<TntWhiteBedEntity> {
    private final ModelPart bedHead;
    private final ModelPart bedFoot;

    public TntWhiteBedBlockEntityRenderer(BlockEntityRendererFactory.Context ctx) {
    ...
    @Override
    public void render(TntWhiteBedEntity bedBlockEntity, float tickDelta, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i, int j) {
