...
public class InvertRedBlockEntityRenderer implements BlockEntityRenderer<InvertRedBedEntity> {
    private final ModelPart bedHead;
    private final ModelPart bedFoot;

    public InvertRedBlockEntityRenderer(BlockEntityRendererFactory.Context ctx) {
...
//        matrices.translate(-0.5F, -0.5F, -0.5F);
    ...
    @Override
    public void render(InvertRedBedEntity bedBlockEntity, float tickDelta, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i, int j) {
