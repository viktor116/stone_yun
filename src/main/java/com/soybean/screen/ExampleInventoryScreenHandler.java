...
public class ExampleInventoryScreenHandler extends ScreenHandler {
    ...
    public ExampleInventoryScreenHandler(int syncId, PlayerInventory playerInventory, BlockPosPayload payload) {
        this(syncId, playerInventory, (InventoryBlockEntity) playerInventory.player.getWorld().getBlockEntity(payload.pos()));
    }

    // Main Constructor - (Directly called from server)
    public ExampleInventoryScreenHandler(int syncId, PlayerInventory playerInventory, InventoryBlockEntity blockEntity) {
